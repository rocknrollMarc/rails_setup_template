...
* Removed the turn gem and moved the guard gems in to the development group.
* Removed the rack-webconsole gem.
* Renamed the application and development files so they include and clearly indicate 'delta' in the name.
