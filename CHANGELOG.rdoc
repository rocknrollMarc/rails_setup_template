...
* Upgraded to {jQuery Block UI 2.33}[http://github.com/malsup/blockui].
...
* Upgraded to {Underscore 1.1.0}[http://github.com/documentcloud/underscore].
...
* Removed the heroku.rake file. See the {Heroku Plus}[http://github.com/aeonscope/heroku_plus] gem for additional capabilities.
* Replaced the Awesome Nested Set with the {Lineage}[http://github.com/aeonscope/lineage] gem.
* Removed the LESS[http://lesscss.org] gem and related More[http://github.com/cloudhead/more] plugin.
...
* Added the More[http://github.com/cloudhead/more] plugin.
* Added the {Rails Indexes}[http://github.com/eladmeidar/rails_indexes] plugin.
* Added the Formtastic[http://github.com/justinfrench/formtastic] gem requirement.
* Added the Bullet[http://github.com/flyerhzm/bullet] gem requirement.
* Added the Deadweight[http://github.com/aanand/deadweight] gem requirement.
...
* Added the Underscore[http://github.com/documentcloud/underscore] JavaScript library.
...
* Upgraded to {Blueprint 0.9.1}[http://github.com/joshuaclayton/blueprint-css].
