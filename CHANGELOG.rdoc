...
* Upgraded to {jQuery 1.5.1}[http://jquery.com].
* Upgraded to {jQuery UI 1.8.11}[http://jqueryui.com].
* Upgraded to {jQuery Mark It Up 1.1.10}[http://markitup.jaysalvat.com].
...
* Replaced the Acts as List gem with the {Sorted List}[https://github.com/bkuhlmann/sorted_list]
* Removed the position_helper since it is part of the Sorted List gem now.
* Removed any images related to jQuery TOOLS library. Updated the CSS to behave like the orignal images.
