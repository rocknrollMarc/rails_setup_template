...
* Upgraded to {jQuery Mark It Up 1.1.9}[http://markitup.jaysalvat.com].
* Upgraded to {jQuery 1.4.4}[http://jquery.com] JavaScript library.
* Upgraded to {jQuery UI 1.8.6}[http://jqueryui.com] JavaScript library.
...
* Removed the heroku.rake file. See the {Heroku Plus}[https://github.com/aeonscope/heroku_plus] gem for additional capabilities.
* Replaced the Awesome Nested Set with the {Lineage}[https://github.com/aeonscope/lineage] gem.
