...
* Installs the {jQuery 1.7.1}[http://jquery.com] JavaScript library.
* Installs the {jQuery UI 1.8.17}[http://jqueryui.com] JavaScript library.
...
* Installs the {Modernizr 2.6.0}[http://www.modernizr.com] JavaScript library.
...
* Added the AndAnd[http://andand.rubyforge.org] gem requirement.
* Adds the {Ruby Debug}[http://rubyforge.org/projects/ruby-debug] gem requirement.
* Adds the Wirble[https://github.com/blackwinter/wirble] gem requirement.
...
* Adds the {Ruby Growl}[http://rubyforge.org/projects/ruby-growl] gem requirement.
* Adds the {Rack Webconsole}[https://github.com/codegram/rack-webconsole] gem requirement.
* Adds the {Active Sanity}[https://github.com/versapay/active_sanity] gem requirement.
* Adds the {Color Blind}[https://github.com/codegram/colorblind] gem requirement.
...
Current Version (stable):
  ...
  rails new demo -d=sqlite3 -J -T -f --skip-bundle -m https://raw.github.com/bkuhlmann/rails_setup_template/v4.0.0/template.rb
