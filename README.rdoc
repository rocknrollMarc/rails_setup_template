...
* Uses {Ruby on Rails 3.2.2}[http://rubyonrails.org].
* Installs the {jQuery 1.7.1}[http://jquery.com] JavaScript library.
* Installs the {jQuery UI 1.8.18}[http://jqueryui.com] JavaScript library.
...
* Installs the {Twitter Bootstrap 2.0.2}[http://twitter.github.com/bootstrap] JavaScript libraries.
...
Current Version (stable):
  ...
  rails new demo -d sqlite3 -J -T -f --skip-bundle -m https://raw.github.com/bkuhlmann/rails_setup_template/v4.3.0/template.rb
