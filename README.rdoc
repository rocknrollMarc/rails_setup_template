...
* Uses {Ruby 1.9.3-p194}[http://www.ruby-lang.org].
* Uses {Ruby on Rails 3.2.6}[http://rubyonrails.org].
* Installs the {jQuery 1.7.2}[http://jquery.com] JavaScript library.
* Installs the {jQuery UI 1.8.21}[http://jqueryui.com] JavaScript library.
...
* Installs the {Twitter Bootstrap 2.0.4}[http://twitter.github.com/bootstrap] JavaScript libraries.
* Installs the {Underscore 1.3.3}[https://github.com/documentcloud/underscore] JavaScript library.
...
* Adds the {Pry Nav}[https://github.com/nixme/pry-nav] gem requirement.
...
Current Version (stable):
  ...
  rails new demo -d sqlite3 -J -T -f --skip-bundle -m https://raw.github.com/bkuhlmann/rails_setup_template/v4.5.0/template.rb
