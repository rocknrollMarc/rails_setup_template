...
* Uses {Ruby 1.9.3-p125}[http://www.ruby-lang.org].
* Uses {Ruby on Rails 3.2.1}[http://rubyonrails.org].
...
* Installs the {Twitter Bootstrap 2.0.1}[http://twitter.github.com/bootstrap] JavaScript libraries.
* Installs the {Underscore 1.3.1}[https://github.com/documentcloud/underscore] JavaScript library.
* Installs the {Modernizr 2.5.3}[http://www.modernizr.com] JavaScript library.
...
3. {Ruby on Rails 3.x}[http://rubyonrails.org].
...
Current Version (stable):
  ...
  rails new demo -d sqlite3 -J -T -f --skip-bundle -m https://raw.github.com/bkuhlmann/rails_setup_template/v4.2.0/template.rb
...
BTW, you can reduce unnecessary typing with new app generation by adding the new rails options, listed above,
to your .railsrc file and simply type "rails new demo" each time. See my
{.railsrc}[https://github.com/bkuhlmann/dotfiles/blob/master/home_files/railsrc.txt] file for usage.
