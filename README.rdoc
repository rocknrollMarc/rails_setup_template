...
* Installs {Twitter Bootstrap}[http://twitter.github.com/bootstrap] assets.
...
Current Version (stable):
  ...
  rails new demo -d=sqlite3 -J -T -f --skip-bundle -m https://raw.github.com/bkuhlmann/rails_setup_template/v4.1.0/template.rb
