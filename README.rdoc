...
* Uses {Ruby 1.9.3-p374}[http://www.ruby-lang.org].
* Uses {Ruby on Rails 3.2.11}[http://rubyonrails.org].
* Installs the {jQuery 1.9.0}[http://jquery.com] JavaScript library.
* Installs the {jQuery UI 1.10.0}[http://jqueryui.com] JavaScript library.
...
* Installs the {Twitter Bootstrap 2.2.2}[http://twitter.github.com/bootstrap] JavaScript libraries.
* Installs the {Underscore 1.4.3}[https://github.com/documentcloud/underscore] JavaScript library.
